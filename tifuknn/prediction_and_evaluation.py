...
if __name__ == '__main__':
    ...
    parser.add_argument("--ground_truth_path", default="./data/VS_future_order.csv")
    parser.add_argument("--checkpoint", default="VS_checkpoint/rg_0.6_rb_1.0_gs_7", help="checkpoint path")
