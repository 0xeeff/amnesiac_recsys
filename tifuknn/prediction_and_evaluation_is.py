...
if __name__ == '__main__':
    ...
    parser.add_argument("--ground_truth_path", default="./data/Instacart_future.csv")
    parser.add_argument("--checkpoint", default="Instacart_checkpoint/rg_0.7_rb_0.9_gs_3", help="checkpoint path")
    parser.add_argument("--num_neighbours", default=900, type=int, help="the size of a group")
    parser.add_argument("--topn", default=20, type=int, help="the size of a group")
    parser.add_argument("--alpha", default=0.9, type=float, help="clear path")
