...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_file", help="historical baskets", default="./data/Instacart_history.csv")
    parser.add_argument("--group_size", default=3, type=int, help="the size of a group")
    parser.add_argument("--checkpoint", default="Instacart_checkpoint", help="checkpoint path")
